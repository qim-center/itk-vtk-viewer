...
function createScreenshotButton(context, mainUIRow) {
  ...
  screenshotButton.innerHTML = "<input id=\"".concat(context.id, "-screenshotButton\" type=\"checkbox\" checked class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-bottom-annotations itk-vtk-tooltip-content=\"Screenshot\" class=\"").concat(style.screenshotButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-screenshotButton\"><img src=\"").concat(optimizedSVGDataUri$8, "\" alt=\"screenshot\" /></label>");
  screenshotButton.children[0];
  var screenshotLabel = screenshotButton.children[1];
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', screenshotLabel);
...
window.addEventListener('load', function () {
  ...
  ;
  [['requestFullscreen', 'exitFullscreen', 'fullscreenchange', 'fullscreen'], ['mozRequestFullScreen', 'mozCancelFullScreen', 'mozfullscreenchange', 'mozFullScreen'], ['msRequestFullscreen', 'msExitFullscreen', 'MSFullscreenChange', 'msFullscreenEnabled'], ['webkitRequestFullscreen', 'webkitExitFullscreen', 'webkitfullscreenchange', 'webkitIsFullScreen']].forEach(function (methods) {
    if (body[methods[0]] && fullscreenMethods.length === 0) {
      fullscreenMethods.splice.apply(fullscreenMethods, [methods, methods.length].concat(_toConsumableArray(methods)));
    }
  });
});
...
function createRotateButton(context, mainUIRow) {
  ...
  rotateButton.innerHTML = "<input id=\"".concat(context.id, "-toggleRotateButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-fullscreen itk-vtk-tooltip-content=\"Spin in 3D [p]\" class=\"").concat(style.rotateButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-toggleRotateButton\"><img src=\"").concat(optimizedSVGDataUri$b, "\" alt=\"rotate\"/></label>");
  ...
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', rotateButtonLabel);
...
function toggleAnnotations(context) {
  if (context.main.annotationsButtonInput) {
    context.main.annotationsButtonInput.checked = context.main.annotationsEnabled;
  }
}
...
function createViewPlanesToggle(context, volumeRow) {
  ...
  viewPlanesButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-toggleSlicingPlanesButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-axes itk-vtk-tooltip-content=\"View planes [s]\" class=\"").concat(style.viewPlanesButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-toggleSlicingPlanesButton\"><img src=\"").concat(optimizedSVGDataUri$4, "\" alt=\"view planes\" /></label>");
  ...
  applyContrastSensitiveStyleToElement(context, 'tooltipButton', viewPlanesButtonLabel);
  viewPlanesButton.addEventListener('change', function (event) {
    event.preventDefault();
    event.stopPropagation();
    var slicingPlanes = context.main.slicingPlanes;
    if (!slicingPlanes.x.visibile && !slicingPlanes.y.visible && !slicingPlanes.z.visible) {
...
function createPlaneSliders(context) {
  ...
  xPlaneVisibleButton.innerHTML = "<input id=\"".concat(context.id, "-xPlaneVisibleButton\" type=\"checkbox\" checked class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"X plane visibility\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-xPlaneVisibleButton\"><img src=\"").concat(optimizedSVGDataUri$3, "\" alt=\"visible\" /></label>");
  ...
  xPlaneInvisibleButton.innerHTML = "<input id=\"".concat(context.id, "-invisibleButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"X plane visibility\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-xPlaneInvisibleButton\"><img src=\"").concat(optimizedSVGDataUri$l, "\" alt=\"invisible\" /></label>");
  ...
  xPlanePauseButton.innerHTML = "<input id=\"".concat(context.id, "-xPlanePauseButton\" type=\"checkbox\" checked class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"X plane pause scroll\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-xPlanePauseButton\"><img src=\"").concat(optimizedSVGDataUri$h, "\" alt=\"pause\" /></label>");
  ...
  xPlanePlayButton.innerHTML = "<input id=\"".concat(context.id, "-xPlanePlayButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"X plane play scroll\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-xPlanePlayButton\"><img src=\"").concat(optimizedSVGDataUri$g, "\" alt=\"play\"/></label>");
  ...
  xSliderEntry.innerHTML = "\n    <label id=\"".concat(viewerDOMId, "-xSliceLabel\" class=\"").concat(style.xPlaneLabel, "\">X:</label><input type=\"range\" min=\"0.0\" max=\"1.0\" value=\"0.5\" step=\"0.1\"\n      id=\"").concat(viewerDOMId, "-xSlice\" class=\"").concat(style.slider, "\" />");
  var xPlaneLabel = xSliderEntry.querySelector("#".concat(viewerDOMId, "-xSliceLabel"));
  context.main.xPlaneLabel = xPlaneLabel;
  var xSliceElement = xSliderEntry.querySelector("#".concat(viewerDOMId, "-xSlice"));
  ...
  yPlaneVisibleButton.innerHTML = "<input id=\"".concat(context.id, "-yPlaneVisibleButton\" type=\"checkbox\" checked class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Y plane visibility\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-yPlaneVisibleButton\"><img src=\"").concat(optimizedSVGDataUri$3, "\" alt=\"visible\"/></label>");
  ...
  yPlaneInvisibleButton.innerHTML = "<input id=\"".concat(context.id, "-invisibleButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Y plane visibility\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-yPlaneInvisibleButton\"><img src=\"").concat(optimizedSVGDataUri$l, "\" alt=\"invisible\" /></label>");
  ...
  yPlanePauseButton.innerHTML = "<input id=\"".concat(context.id, "-yPlanePauseButton\" type=\"checkbox\" checked class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Y plane pause scroll\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-yPlanePauseButton\"><img src=\"").concat(optimizedSVGDataUri$h, "\" alt=\"pause\" /></label>");
  ...
  yPlanePlayButton.innerHTML = "<input id=\"".concat(context.id, "-yPlanePlayButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Y plane play scroll\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-yPlanePlayButton\"><img src=\"").concat(optimizedSVGDataUri$g, "\" alt=\"play\"/></label>");
  ...
  ySliderEntry.innerHTML = "\n    <label id=\"".concat(viewerDOMId, "-ySliceLabel\" class=\"").concat(style.yPlaneLabel, "\">Y:</label><input type=\"range\" min=\"0.0\" max=\"1.0\" value=\"0.5\" step=\"0.1\"\n      id=\"").concat(viewerDOMId, "-ySlice\" class=\"").concat(style.slider, "\" />");
  var yPlaneLabel = ySliderEntry.querySelector("#".concat(viewerDOMId, "-ySliceLabel"));
  context.main.yPlaneLabel = yPlaneLabel;
  var ySliceElement = ySliderEntry.querySelector("#".concat(viewerDOMId, "-ySlice"));
  ...
  zPlaneVisibleButton.innerHTML = "<input id=\"".concat(context.id, "-zPlaneVisibleButton\" type=\"checkbox\" checked class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Z plane visibility\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-zPlaneVisibleButton\"><img src=\"").concat(optimizedSVGDataUri$3, "\" alt=\"visible\" /></label>");
  ...
  zPlaneInvisibleButton.innerHTML = "<input id=\"".concat(context.id, "-invisibleButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Z plane visibility\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-zPlaneInvisibleButton\"><img src=\"").concat(optimizedSVGDataUri$l, "\" alt=\"invisible\" /></label>");
  ...
  zPlanePauseButton.innerHTML = "<input id=\"".concat(context.id, "-zPlanePauseButton\" type=\"checkbox\" checked class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Z plane pause scroll\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-zPlanePauseButton\"><img src=\"").concat(optimizedSVGDataUri$h, "\" alt=\"pause\" /></label>");
  ...
  zPlanePlayButton.innerHTML = "<input id=\"".concat(context.id, "-zPlanePlayButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Z plane play scroll\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-zPlanePlayButton\"><img src=\"").concat(optimizedSVGDataUri$g, "\" alt=\"play\" /></label>");
  ...
  zSliderEntry.innerHTML = "\n    <label id=\"".concat(viewerDOMId, "-zSliceLabel\" class=\"").concat(style.zPlaneLabel, "\">Z:</label><input type=\"range\" min=\"0.0\" max=\"1.0\" value=\"0.5\" step=\"0.1\"\n      id=\"").concat(viewerDOMId, "-zSlice\" class=\"").concat(style.slider, "\" />");
  var zPlaneLabel = zSliderEntry.querySelector("#".concat(viewerDOMId, "-zSliceLabel"));
  context.main.zPlaneLabel = zPlaneLabel;
  var zSliceElement = zSliderEntry.querySelector("#".concat(viewerDOMId, "-zSlice"));
...
function createBackgroundColorButton(context, mainUIRow) {
  ...
  bgColorButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-bgColorButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\" checked><label itk-vtk-tooltip itk-vtk-tooltip-left itk-vtk-tooltip-content=\"Toggle Background Color\" class=\"").concat(style.bgColorButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-bgColorButton\"><img src=\"").concat(optimizedSVGDataUri$7, "\" alt=\"select color\" /></label>");
...
function createCroppingButtons(context, mainUIRow) {
  ...
  cropButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-toggleCroppingPlanesButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"Cropping planes [w]\" class=\"").concat(style.cropButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-toggleCroppingPlanesButton\"><img src=\"").concat(optimizedSVGDataUri$r, "\" alt=\"crop\"/></label>");
  ...
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', cropButtonLabel);
  ...
  resetCropButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-resetCroppingPlanesButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\" checked><label itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"Reset cropping planes [e]\" class=\"").concat(style.resetCropButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-resetCroppingPlanesButton\"><img src=\"").concat(optimizedSVGDataUri$d, "\" alt=\"reset crop\"/></label>");
  var resetCropButtonLabel = resetCropButton.children[1];
  context.main.resetCropButtonLabel = resetCropButtonLabel;
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', resetCropButtonLabel);
...
function createViewModeButtons(context, mainRow) {
  ...
  xPlaneButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-xPlaneButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"X plane [1]\" class=\"").concat(style.viewModeButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-xPlaneButton\"><img src=\"").concat(optimizedSVGDataUri$f, "\" alt=\"x plane\"/></label>");
  var xPlaneButtonLabel = xPlaneButton.children[1];
  context.main.xPlaneButtonLabel = xPlaneButtonLabel;
  applyContrastSensitiveStyleToElement(context, 'tooltipButton', xPlaneButtonLabel);
  ...
  yPlaneButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-yPlaneButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"Y plane [2]\" class=\"").concat(style.viewModeButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-yPlaneButton\"><img src=\"").concat(optimizedSVGDataUri, "\" alt=\"y plane\" /></label>");
  var yPlaneButtonLabel = yPlaneButton.children[1];
  context.main.yPlaneButtonLabel = yPlaneButtonLabel;
  applyContrastSensitiveStyleToElement(context, 'tooltipButton', yPlaneButtonLabel);
  ...
  zPlaneButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-zPlaneButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"Z plane [3]\" class=\"").concat(style.viewModeButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-zPlaneButton\"><img src=\"").concat(optimizedSVGDataUri$o, "\" alt=\"z plane\" /></label>");
  var zPlaneButtonLabel = zPlaneButton.children[1];
  context.main.zPlaneButtonLabel = zPlaneButtonLabel;
  applyContrastSensitiveStyleToElement(context, 'tooltipButton', zPlaneButtonLabel);
  ...
  volumeButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-volumeButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\" checked><label itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"Volume [4]\" class=\"").concat(style.viewModeButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-volumeButton\"><img src=\"").concat(optimizedSVGDataUri$2, "\" alt=\"volume\" /></label>");
  var volumeButtonLabel = volumeButton.children[1];
  context.main.volumeButtonLabel = volumeButtonLabel;
  applyContrastSensitiveStyleToElement(context, 'tooltipButton', volumeButtonLabel);
...
function createResetCameraButton(context, mainUIRow) {
  ...
  resetCameraButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-resetCameraButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\" checked><label itk-vtk-tooltip itk-vtk-tooltip-left itk-vtk-tooltip-content=\"Reset camera [r]\" class=\"").concat(style.resetCameraButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-resetCameraButton\"><img src=\"").concat(optimizedSVGDataUri$e, "\" alt=\"reset camera\" /></label>");
  var resetCameraButtonLabel = resetCameraButton.children[1];
  context.main.resetCameraButtonLabel = resetCameraButtonLabel;
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', resetCameraButtonLabel);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const e$h=(e,t,c)=>(c.configurable=!0,c.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,c),c);

/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function e$g(e,r){return (n,s,i)=>{const o=t=>t.renderRoot?.querySelector(e)??null;if(r){const{get:e,set:r}="object"==typeof s?n:i??(()=>{const t=Symbol();return {get(){return this[t]},set(e){this[t]=e;}}})();return e$h(n,s,{get(){let t=e.call(this);return void 0===t&&(t=o(this),(null!==t||this.hasUpdated)&&r.call(this,t)),t}})}return e$h(n,s,{get(){return o(this)}})}}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
let e$f;function r$7(r){return (n,o)=>e$h(n,o,{get(){return (this.renderRoot??(e$f??=document.createDocumentFragment())).querySelectorAll(r)}})}

/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function o$c(o){return (e,n)=>{const{slot:r,selector:s}=o??{},c="slot"+(r?`[name=${r}]`:":not([name])");return e$h(e,n,{get(){const t=this.renderRoot?.querySelector(c),e=t?.assignedElements(o)??[];return void 0===s?e:e.filter((t=>t.matches(s)))}})}}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$7=globalThis,i$6=t$7.trustedTypes,s$a=i$6?i$6.createPolicy("lit-html",{createHTML:t=>t}):void 0,e$e="$lit$",h$4=`lit$${(Math.random()+"").slice(9)}$`,o$b="?"+h$4,n$a=`<${o$b}>`,r$6=document,l$5=()=>r$6.createComment(""),c$3=t=>null===t||"object"!=typeof t&&"function"!=typeof t,a$4=Array.isArray,u$1=t=>a$4(t)||"function"==typeof t?.[Symbol.iterator],d$2="[ \t\n\f\r]",f$1=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,v$1=/-->/g,_$1=/>/g,m$1=RegExp(`>|${d$2}(?:([^\\s"'>=/]+)(${d$2}*=${d$2}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),p$1=/'/g,g$1=/"/g,$$2=/^(?:script|style|textarea|title)$/i,y$1=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),x$1=y$1(1),w=Symbol.for("lit-noChange"),T$1=Symbol.for("lit-nothing"),A$1=new WeakMap,E$1=r$6.createTreeWalker(r$6,129);function C$2(t,i){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==s$a?s$a.createHTML(i):i}const P$1=(t,i)=>{const s=t.length-1,o=[];let r,l=2===i?"<svg>":"",c=f$1;for(let i=0;i<s;i++){const s=t[i];let a,u,d=-1,y=0;for(;y<s.length&&(c.lastIndex=y,u=c.exec(s),null!==u);)y=c.lastIndex,c===f$1?"!--"===u[1]?c=v$1:void 0!==u[1]?c=_$1:void 0!==u[2]?($$2.test(u[2])&&(r=RegExp("</"+u[2],"g")),c=m$1):void 0!==u[3]&&(c=m$1):c===m$1?">"===u[0]?(c=r??f$1,d=-1):void 0===u[1]?d=-2:(d=c.lastIndex-u[2].length,a=u[1],c=void 0===u[3]?m$1:'"'===u[3]?g$1:p$1):c===g$1||c===p$1?c=m$1:c===v$1||c===_$1?c=f$1:(c=m$1,r=void 0);const x=c===m$1&&t[i+1].startsWith("/>")?" ":"";l+=c===f$1?s+n$a:d>=0?(o.push(a),s.slice(0,d)+e$e+s.slice(d)+h$4+x):s+h$4+(-2===d?i:x);}return [C$2(t,l+(t[s]||"<?>")+(2===i?"</svg>":"")),o]};class V$2{constructor({strings:t,_$litType$:s},n){let r;this.parts=[];let c=0,a=0;const u=t.length-1,d=this.parts,[f,v]=P$1(t,s);if(this.el=V$2.createElement(f,n),E$1.currentNode=this.el.content,2===s){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes);}for(;null!==(r=E$1.nextNode())&&d.length<u;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(e$e)){const i=v[a++],s=r.getAttribute(t).split(h$4),e=/([.?@])?(.*)/.exec(i);d.push({type:1,index:c,name:e[2],strings:s,ctor:"."===e[1]?k$1:"?"===e[1]?H$1:"@"===e[1]?I$1:R$1}),r.removeAttribute(t);}else t.startsWith(h$4)&&(d.push({type:6,index:c}),r.removeAttribute(t));if($$2.test(r.tagName)){const t=r.textContent.split(h$4),s=t.length-1;if(s>0){r.textContent=i$6?i$6.emptyScript:"";for(let i=0;i<s;i++)r.append(t[i],l$5()),E$1.nextNode(),d.push({type:2,index:++c});r.append(t[s],l$5());}}}else if(8===r.nodeType)if(r.data===o$b)d.push({type:2,index:c});else {let t=-1;for(;-1!==(t=r.data.indexOf(h$4,t+1));)d.push({type:7,index:c}),t+=h$4.length-1;}c++;}}static createElement(t,i){const s=r$6.createElement("template");return s.innerHTML=t,s}}function N$2(t,i,s=t,e){if(i===w)return i;let h=void 0!==e?s._$Co?.[e]:s._$Cl;const o=c$3(i)?void 0:i._$litDirective$;return h?.constructor!==o&&(h?._$AO?.(!1),void 0===o?h=void 0:(h=new o(t),h._$AT(t,s,e)),void 0!==e?(s._$Co??=[])[e]=h:s._$Cl=h),void 0!==h&&(i=N$2(t,h._$AS(t,i.values),h,e)),i}class S$2{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:s}=this._$AD,e=(t?.creationScope??r$6).importNode(i,!0);E$1.currentNode=e;let h=E$1.nextNode(),o=0,n=0,l=s[0];for(;void 0!==l;){if(o===l.index){let i;2===l.type?i=new M$1(h,h.nextSibling,this,t):1===l.type?i=new l.ctor(h,l.name,l.strings,this,t):6===l.type&&(i=new L$1(h,this,t)),this._$AV.push(i),l=s[++n];}o!==l?.index&&(h=E$1.nextNode(),o++);}return E$1.currentNode=r$6,e}p(t){let i=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}}class M$1{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,i,s,e){this.type=2,this._$AH=T$1,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cv=e?.isConnected??!0;}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t?.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=N$2(this,t,i),c$3(t)?t===T$1||null==t||""===t?(this._$AH!==T$1&&this._$AR(),this._$AH=T$1):t!==this._$AH&&t!==w&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):u$1(t)?this.T(t):this._(t);}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t));}_(t){this._$AH!==T$1&&c$3(this._$AH)?this._$AA.nextSibling.data=t:this.$(r$6.createTextNode(t)),this._$AH=t;}g(t){const{values:i,_$litType$:s}=t,e="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=V$2.createElement(C$2(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===e)this._$AH.p(i);else {const t=new S$2(e,this),s=t.u(this.options);t.p(i),this.$(s),this._$AH=t;}}_$AC(t){let i=A$1.get(t.strings);return void 0===i&&A$1.set(t.strings,i=new V$2(t)),i}T(t){a$4(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const h of t)e===i.length?i.push(s=new M$1(this.k(l$5()),this.k(l$5()),this,this.options)):s=i[e],s._$AI(h),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t));}}class R$1{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,s,e,h){this.type=1,this._$AH=T$1,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=h,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=T$1;}_$AI(t,i=this,s,e){const h=this.strings;let o=!1;if(void 0===h)t=N$2(this,t,i,0),o=!c$3(t)||t!==this._$AH&&t!==w,o&&(this._$AH=t);else {const e=t;let n,r;for(t=h[0],n=0;n<h.length-1;n++)r=N$2(this,e[s+n],i,n),r===w&&(r=this._$AH[n]),o||=!c$3(r)||r!==this._$AH[n],r===T$1?t=T$1:t!==T$1&&(t+=(r??"")+h[n+1]),this._$AH[n]=r;}o&&!e&&this.O(t);}O(t){t===T$1?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"");}}class k$1 extends R$1{constructor(){super(...arguments),this.type=3;}O(t){this.element[this.name]=t===T$1?void 0:t;}}class H$1 extends R$1{constructor(){super(...arguments),this.type=4;}O(t){this.element.toggleAttribute(this.name,!!t&&t!==T$1);}}class I$1 extends R$1{constructor(t,i,s,e,h){super(t,i,s,e,h),this.type=5;}_$AI(t,i=this){if((t=N$2(this,t,i,0)??T$1)===w)return;const s=this._$AH,e=t===T$1&&s!==T$1||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,h=t!==T$1&&(s===T$1||e);e&&this.element.removeEventListener(this.name,this,s),h&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t);}}class L$1{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){N$2(this,t);}}const Z$2=t$7.litHtmlPolyfillSupport;Z$2?.(V$2,M$1),(t$7.litHtmlVersions??=[]).push("3.1.0");const j$1=(t,i,s)=>{const e=s?.renderBefore??i;let h=e._$litPart$;if(void 0===h){const t=s?.renderBefore??null;e._$litPart$=h=new M$1(i.insertBefore(l$5(),t),t,void 0,s??{});}return h._$AI(t),h};

/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class s$9 extends b$1{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0;}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=j$1(i,this.renderRoot,this.renderOptions);}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0);}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1);}render(){return w}}s$9._$litElement$=!0,s$9[("finalized")]=!0,globalThis.litElementHydrateSupport?.({LitElement:s$9});const r$5=globalThis.litElementPolyfillSupport;r$5?.({LitElement:s$9});(globalThis.litElementVersions??=[]).push("4.0.2");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$6={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},e$d=t=>(...e)=>({_$litDirective$:t,values:e});class i$5{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i;}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}

/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const e$c=e$d(class extends i$5{constructor(t){if(super(t),t.type!==t$6.ATTRIBUTE||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return " "+Object.keys(t).filter((s=>t[s])).join(" ")+" "}update(s,[i]){if(void 0===this.it){this.it=new Set,void 0!==s.strings&&(this.st=new Set(s.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in i)i[t]&&!this.st?.has(t)&&this.it.add(t);return this.render(i)}const r=s.element.classList;for(const t of this.it)t in i||(r.remove(t),this.it.delete(t));for(const t in i){const s=!!i[t];s===this.it.has(t)||this.st?.has(t)||(s?(r.add(t),this.it.add(t)):(r.remove(t),this.it.delete(t)));}return w}});
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const e$b=Symbol.for(""),o$a=t=>{if(t?.r===e$b)return t?._$litStatic$},s$8=(t,...r)=>({_$litStatic$:r.reduce(((r,e,o)=>r+(t=>{if(void 0!==t._$litStatic$)return t._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(e)+t[o+1]),t[0]),r:e$b}),a$3=new Map,l$4=t=>(r,...e)=>{const i=e.length;let s,l;const n=[],u=[];let c,$=0,f=!1;for(;$<i;){for(c=r[$];$<i&&void 0!==(l=e[$],s=o$a(l));)c+=s+r[++$],f=!0;$!==i&&u.push(l),n.push(c),$++;}if($===i&&n.push(r[i]),f){const t=n.join("$$lit$$");void 0===(r=a$3.get(t))&&(n.raw=n,a$3.set(t,r=n)),e=u;}return t(r,...e)},n$9=l$4(x$1);
...
function createDownloadROIButton(context, mainUIRow) {
  ...
  if (!dialog) {
    dialog = makeHtml("\n      <md-dialog class=\"".concat(style.saveDialog, "\">\n        <div slot=\"headline\">Save file format</div>\n        <form id=\"save-form\" slot=\"content\" method=\"dialog\">\n          ").concat(extensions.map(function (extension, i) {
      return "<label>\n                  <md-radio name=\"format\" value=\"".concat(extension, "\" ").concat(i === 0 ? 'checked' : '', " touch-target=\"wrapper\"></md-radio>\n                  <span aria-hidden=\"true\">").concat(extension, "</span>\n                </label>");
  ...
  // Create the button
  var downloadROIButton = document.createElement('div');
  downloadROIButton.innerHTML = "\n    <input type=\"checkbox\" id=\"".concat(context.id, "-download-roi\" class=\"").concat(style.toggleInput, "\" />\n    <label itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"Save ROI\" class=\"").concat(style.toggleButton, "\" for=\"").concat(context.id, "-download-roi\">\n      <img style=\"height: 23px\" src=\"").concat(optimizedSVGDataUri$q, "\" />\n    </label>\n  ");
  var downloadROIButtonLabel = downloadROIButton.children[1];
  downloadROIButton.style.height = '23px';
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', downloadROIButtonLabel);
  ...
  downloadROIButton.addEventListener('click', function (event) {
    event.stopPropagation();
    dialog.show();
  });
...
function createMainInterface(context) {
  ...
  var mainUIColumn = document.createElement('div');
  ...
  var createButtonRow = function createButtonRow(labelText, buttonCreator) {
...
function toggleBackgroundColor(context) {
  context.main.selectedBackgroundColor = (context.main.selectedBackgroundColor + 1) % context.main.backgroundColors.length;
  context.main.backgroundColor = context.main.backgroundColors[context.main.selectedBackgroundColor];
}
...
function viewModeVolume$1(context) {
  ...
  main.xPlaneVisibleButton.style.display = slicingPlanes.x.visible ? 'flex' : 'none';
  main.xPlaneInvisibleButton.style.display = slicingPlanes.x.visible ? 'none' : 'flex';
  main.yPlaneVisibleButton.style.display = slicingPlanes.y.visible ? 'flex' : 'none';
  main.yPlaneInvisibleButton.style.display = slicingPlanes.y.visible ? 'none' : 'flex';
  main.zPlaneVisibleButton.style.display = slicingPlanes.z.visible ? 'flex' : 'none';
  main.zPlaneInvisibleButton.style.display = slicingPlanes.z.visible ? 'none' : 'flex';
...
function applySlicingPlanes(context, event) {
  ...
  main.xPlanePauseButton.style.display = slicingPlanes.x.scroll ? 'flex' : 'none';
  main.xPlanePlayButton.style.display = slicingPlanes.x.scroll ? 'none' : 'flex';
  main.yPlanePauseButton.style.display = slicingPlanes.y.scroll ? 'flex' : 'none';
  main.yPlanePlayButton.style.display = slicingPlanes.y.scroll ? 'none' : 'flex';
  main.zPlanePauseButton.style.display = slicingPlanes.z.scroll ? 'flex' : 'none';
...
function applyXSlice(context, event) {
  ...
  var padLength = valueString.length < numberOfValueChars ? numberOfValueChars - valueString.length : 0;
...
function createLayersInterface(context) {
  var layersUIGroup = makeHtml("\n    <div class=\"".concat(style.uiGroup, " ").concat(style.uiRow, " ").concat(style.layers, "\"></div>\n  "));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$5=window,e$a=t$5.ShadowRoot&&(void 0===t$5.ShadyCSS||t$5.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s$7=Symbol(),n$8=new WeakMap;class o$9{constructor(t,e,n){if(this._$cssResult$=!0,n!==s$7)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e;}get styleSheet(){let t=this.o;const s=this.t;if(e$a&&void 0===t){const e=void 0!==s&&1===s.length;e&&(t=n$8.get(s)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),e&&n$8.set(s,t));}return t}toString(){return this.cssText}}const r$4=t=>new o$9("string"==typeof t?t:t+"",void 0,s$7),i$4=(t,...e)=>{const n=1===t.length?t[0]:e.reduce(((e,s,n)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[n+1]),t[0]);return new o$9(n,t,s$7)},S$1=(s,n)=>{e$a?s.adoptedStyleSheets=n.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):n.forEach((e=>{const n=document.createElement("style"),o=t$5.litNonce;void 0!==o&&n.setAttribute("nonce",o),n.textContent=e.cssText,s.appendChild(n);}));},c$2=e$a?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return r$4(e)})(t):t;

/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var s$6;const e$9=window,r$3=e$9.trustedTypes,h$3=r$3?r$3.emptyScript:"",o$8=e$9.reactiveElementPolyfillSupport,n$7={toAttribute(t,i){switch(i){case Boolean:t=t?h$3:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t);}return t},fromAttribute(t,i){let s=t;switch(i){case Boolean:s=null!==t;break;case Number:s=null===t?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t);}catch(t){s=null;}}return s}},a$2=(t,i)=>i!==t&&(i==i||t==t),l$3={attribute:!0,type:String,converter:n$7,reflect:!1,hasChanged:a$2};class d$1 extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u();}static addInitializer(t){var i;this.finalize(),(null!==(i=this.h)&&void 0!==i?i:this.h=[]).push(t);}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach(((i,s)=>{const e=this._$Ep(s,i);void 0!==e&&(this._$Ev.set(e,s),t.push(e));})),t}static createProperty(t,i=l$3){if(i.state&&(i.attribute=!1),this.finalize(),this.elementProperties.set(t,i),!i.noAccessor&&!this.prototype.hasOwnProperty(t)){const s="symbol"==typeof t?Symbol():"__"+t,e=this.getPropertyDescriptor(t,s,i);void 0!==e&&Object.defineProperty(this.prototype,t,e);}}static getPropertyDescriptor(t,i,s){return {get(){return this[i]},set(e){const r=this[t];this[i]=e,this.requestUpdate(t,r,s);},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||l$3}static finalize(){if(this.hasOwnProperty("finalized"))return !1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),void 0!==t.h&&(this.h=[...t.h]),this.elementProperties=new Map(t.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const s of i)this.createProperty(s,t[s]);}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(i){const s=[];if(Array.isArray(i)){const e=new Set(i.flat(1/0).reverse());for(const i of e)s.unshift(c$2(i));}else void 0!==i&&s.push(c$2(i));return s}static _$Ep(t,i){const s=i.attribute;return !1===s?void 0:"string"==typeof s?s:"string"==typeof t?t.toLowerCase():void 0}u(){var t;this._$E_=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Eg(),this.requestUpdate(),null===(t=this.constructor.h)||void 0===t||t.forEach((t=>t(this)));}addController(t){var i,s;(null!==(i=this._$ES)&&void 0!==i?i:this._$ES=[]).push(t),void 0!==this.renderRoot&&this.isConnected&&(null===(s=t.hostConnected)||void 0===s||s.call(t));}removeController(t){var i;null===(i=this._$ES)||void 0===i||i.splice(this._$ES.indexOf(t)>>>0,1);}_$Eg(){this.constructor.elementProperties.forEach(((t,i)=>{this.hasOwnProperty(i)&&(this._$Ei.set(i,this[i]),delete this[i]);}));}createRenderRoot(){var t;const s=null!==(t=this.shadowRoot)&&void 0!==t?t:this.attachShadow(this.constructor.shadowRootOptions);return S$1(s,this.constructor.elementStyles),s}connectedCallback(){var t;void 0===this.renderRoot&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),null===(t=this._$ES)||void 0===t||t.forEach((t=>{var i;return null===(i=t.hostConnected)||void 0===i?void 0:i.call(t)}));}enableUpdating(t){}disconnectedCallback(){var t;null===(t=this._$ES)||void 0===t||t.forEach((t=>{var i;return null===(i=t.hostDisconnected)||void 0===i?void 0:i.call(t)}));}attributeChangedCallback(t,i,s){this._$AK(t,s);}_$EO(t,i,s=l$3){var e;const r=this.constructor._$Ep(t,s);if(void 0!==r&&!0===s.reflect){const h=(void 0!==(null===(e=s.converter)||void 0===e?void 0:e.toAttribute)?s.converter:n$7).toAttribute(i,s.type);this._$El=t,null==h?this.removeAttribute(r):this.setAttribute(r,h),this._$El=null;}}_$AK(t,i){var s;const e=this.constructor,r=e._$Ev.get(t);if(void 0!==r&&this._$El!==r){const t=e.getPropertyOptions(r),h="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==(null===(s=t.converter)||void 0===s?void 0:s.fromAttribute)?t.converter:n$7;this._$El=r,this[r]=h.fromAttribute(i,t.type),this._$El=null;}}requestUpdate(t,i,s){let e=!0;void 0!==t&&(((s=s||this.constructor.getPropertyOptions(t)).hasChanged||a$2)(this[t],i)?(this._$AL.has(t)||this._$AL.set(t,i),!0===s.reflect&&this._$El!==t&&(void 0===this._$EC&&(this._$EC=new Map),this._$EC.set(t,s))):e=!1),!this.isUpdatePending&&e&&(this._$E_=this._$Ej());}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_;}catch(t){Promise.reject(t);}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach(((t,i)=>this[i]=t)),this._$Ei=void 0);let i=!1;const s=this._$AL;try{i=this.shouldUpdate(s),i?(this.willUpdate(s),null===(t=this._$ES)||void 0===t||t.forEach((t=>{var i;return null===(i=t.hostUpdate)||void 0===i?void 0:i.call(t)})),this.update(s)):this._$Ek();}catch(t){throw i=!1,this._$Ek(),t}i&&this._$AE(s);}willUpdate(t){}_$AE(t){var i;null===(i=this._$ES)||void 0===i||i.forEach((t=>{var i;return null===(i=t.hostUpdated)||void 0===i?void 0:i.call(t)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t);}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1;}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(t){return !0}update(t){void 0!==this._$EC&&(this._$EC.forEach(((t,i)=>this._$EO(i,this[i],t))),this._$EC=void 0),this._$Ek();}updated(t){}firstUpdated(t){}}d$1.finalized=!0,d$1.elementProperties=new Map,d$1.elementStyles=[],d$1.shadowRootOptions={mode:"open"},null==o$8||o$8({ReactiveElement:d$1}),(null!==(s$6=e$9.reactiveElementVersions)&&void 0!==s$6?s$6:e$9.reactiveElementVersions=[]).push("1.6.1");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var t$4;const i$3=window,s$5=i$3.trustedTypes,e$8=s$5?s$5.createPolicy("lit-html",{createHTML:t=>t}):void 0,o$7=`lit$${(Math.random()+"").slice(9)}$`,n$6="?"+o$7,l$2=`<${n$6}>`,h$2=document,r$2=(t="")=>h$2.createComment(t),d=t=>null===t||"object"!=typeof t&&"function"!=typeof t,u=Array.isArray,c$1=t=>u(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),v=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,a$1=/-->/g,f=/>/g,_=RegExp(">|[ \t\n\f\r](?:([^\\s\"'>=/]+)([ \t\n\f\r]*=[ \t\n\f\r]*(?:[^ \t\n\f\r\"'`<>=]|(\"|')|))|$)","g"),m=/'/g,p=/"/g,$$1=/^(?:script|style|textarea|title)$/i,g=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),y=g(1),x=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),T=new WeakMap,A=h$2.createTreeWalker(h$2,129,null,!1),E=(t,i)=>{const s=t.length-1,n=[];let h,r=2===i?"<svg>":"",d=v;for(let i=0;i<s;i++){const s=t[i];let e,u,c=-1,g=0;for(;g<s.length&&(d.lastIndex=g,u=d.exec(s),null!==u);)g=d.lastIndex,d===v?"!--"===u[1]?d=a$1:void 0!==u[1]?d=f:void 0!==u[2]?($$1.test(u[2])&&(h=RegExp("</"+u[2],"g")),d=_):void 0!==u[3]&&(d=_):d===_?">"===u[0]?(d=null!=h?h:v,c=-1):void 0===u[1]?c=-2:(c=d.lastIndex-u[2].length,e=u[1],d=void 0===u[3]?_:'"'===u[3]?p:m):d===p||d===m?d=_:d===a$1||d===f?d=v:(d=_,h=void 0);const y=d===_&&t[i+1].startsWith("/>")?" ":"";r+=d===v?s+l$2:c>=0?(n.push(e),s.slice(0,c)+"$lit$"+s.slice(c)+o$7+y):s+o$7+(-2===c?(n.push(void 0),i):y);}const u=r+(t[s]||"<?>")+(2===i?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return [void 0!==e$8?e$8.createHTML(u):u,n]};class C$1{constructor({strings:t,_$litType$:i},e){let l;this.parts=[];let h=0,d=0;const u=t.length-1,c=this.parts,[v,a]=E(t,i);if(this.el=C$1.createElement(v,e),A.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes);}for(;null!==(l=A.nextNode())&&c.length<u;){if(1===l.nodeType){if(l.hasAttributes()){const t=[];for(const i of l.getAttributeNames())if(i.endsWith("$lit$")||i.startsWith(o$7)){const s=a[d++];if(t.push(i),void 0!==s){const t=l.getAttribute(s.toLowerCase()+"$lit$").split(o$7),i=/([.?@])?(.*)/.exec(s);c.push({type:1,index:h,name:i[2],strings:t,ctor:"."===i[1]?M:"?"===i[1]?k:"@"===i[1]?H:S});}else c.push({type:6,index:h});}for(const i of t)l.removeAttribute(i);}if($$1.test(l.tagName)){const t=l.textContent.split(o$7),i=t.length-1;if(i>0){l.textContent=s$5?s$5.emptyScript:"";for(let s=0;s<i;s++)l.append(t[s],r$2()),A.nextNode(),c.push({type:2,index:++h});l.append(t[i],r$2());}}}else if(8===l.nodeType)if(l.data===n$6)c.push({type:2,index:h});else {let t=-1;for(;-1!==(t=l.data.indexOf(o$7,t+1));)c.push({type:7,index:h}),t+=o$7.length-1;}h++;}}static createElement(t,i){const s=h$2.createElement("template");return s.innerHTML=t,s}}function P(t,i,s=t,e){var o,n,l,h;if(i===x)return i;let r=void 0!==e?null===(o=s._$Co)||void 0===o?void 0:o[e]:s._$Cl;const u=d(i)?void 0:i._$litDirective$;return (null==r?void 0:r.constructor)!==u&&(null===(n=null==r?void 0:r._$AO)||void 0===n||n.call(r,!1),void 0===u?r=void 0:(r=new u(t),r._$AT(t,s,e)),void 0!==e?(null!==(l=(h=s)._$Co)&&void 0!==l?l:h._$Co=[])[e]=r:s._$Cl=r),void 0!==r&&(i=P(t,r._$AS(t,i.values),r,e)),i}class V$1{constructor(t,i){this.u=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:h$2).importNode(s,!0);A.currentNode=o;let n=A.nextNode(),l=0,r=0,d=e[0];for(;void 0!==d;){if(l===d.index){let i;2===d.type?i=new N$1(n,n.nextSibling,this,t):1===d.type?i=new d.ctor(n,d.name,d.strings,this,t):6===d.type&&(i=new I(n,this,t)),this.u.push(i),d=e[++r];}l!==(null==d?void 0:d.index)&&(n=A.nextNode(),l++);}return o}p(t){let i=0;for(const s of this.u)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}}class N$1{constructor(t,i,s,e){var o;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cm=null===(o=null==e?void 0:e.isConnected)||void 0===o||o;}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cm}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=P(this,t,i),d(t)?t===b||null==t||""===t?(this._$AH!==b&&this._$AR(),this._$AH=b):t!==this._$AH&&t!==x&&this.g(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):c$1(t)?this.k(t):this.g(t);}O(t,i=this._$AB){return this._$AA.parentNode.insertBefore(t,i)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t));}g(t){this._$AH!==b&&d(this._$AH)?this._$AA.nextSibling.data=t:this.T(h$2.createTextNode(t)),this._$AH=t;}$(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=C$1.createElement(e.h,this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.p(s);else {const t=new V$1(o,this),i=t.v(this.options);t.p(s),this.T(i),this._$AH=t;}}_$AC(t){let i=T.get(t.strings);return void 0===i&&T.set(t.strings,i=new C$1(t)),i}k(t){u(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new N$1(this.O(r$2()),this.O(r$2()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,!1,!0,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i;}}setConnected(t){var i;void 0===this._$AM&&(this._$Cm=t,null===(i=this._$AP)||void 0===i||i.call(this,t));}}class S{constructor(t,i,s,e,o){this.type=1,this._$AH=b,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=b;}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=!1;if(void 0===o)t=P(this,t,i,0),n=!d(t)||t!==this._$AH&&t!==x,n&&(this._$AH=t);else {const e=t;let l,h;for(t=o[0],l=0;l<o.length-1;l++)h=P(this,e[s+l],i,l),h===x&&(h=this._$AH[l]),n||(n=!d(h)||h!==this._$AH[l]),h===b?t=b:t!==b&&(t+=(null!=h?h:"")+o[l+1]),this._$AH[l]=h;}n&&!e&&this.j(t);}j(t){t===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"");}}class M extends S{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===b?void 0:t;}}const R=s$5?s$5.emptyScript:"";class k extends S{constructor(){super(...arguments),this.type=4;}j(t){t&&t!==b?this.element.setAttribute(this.name,R):this.element.removeAttribute(this.name);}}class H extends S{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5;}_$AI(t,i=this){var s;if((t=null!==(s=P(this,t,i,0))&&void 0!==s?s:b)===x)return;const e=this._$AH,o=t===b&&e!==b||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==b&&(e===b||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t);}}class I{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){P(this,t);}}const z=i$3.litHtmlPolyfillSupport;null==z||z(C$1,N$1),(null!==(t$4=i$3.litHtmlVersions)&&void 0!==t$4?t$4:i$3.litHtmlVersions=[]).push("2.6.1");const Z$1=(t,i,s)=>{var e,o;const n=null!==(e=null==s?void 0:s.renderBefore)&&void 0!==e?e:i;let l=n._$litPart$;if(void 0===l){const t=null!==(o=null==s?void 0:s.renderBefore)&&void 0!==o?o:null;n._$litPart$=l=new N$1(i.insertBefore(r$2(),t),t,void 0,null!=s?s:{});}return l._$AI(t),l};

/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var l$1,o$6;class s$4 extends d$1{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0;}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Z$1(i,this.renderRoot,this.renderOptions);}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0);}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1);}render(){return x}}s$4.finalized=!0,s$4._$litElement$=!0,null===(l$1=globalThis.litElementHydrateSupport)||void 0===l$1||l$1.call(globalThis,{LitElement:s$4});const n$5=globalThis.litElementPolyfillSupport;null==n$5||n$5({LitElement:s$4});(null!==(o$6=globalThis.litElementVersions)&&void 0!==o$6?o$6:globalThis.litElementVersions=[]).push("3.2.2");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class s$3 extends Event{constructor(s,t,e){super("context-request",{bubbles:!0,composed:!0}),this.context=s,this.callback=t,this.subscribe=e;}}
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class s$2{constructor(t,s,i,h=!1){this.host=t,this.context=s,this.callback=i,this.subscribe=h,this.provided=!1,this.value=void 0,this.host.addController(this);}hostConnected(){this.dispatchRequest();}hostDisconnected(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=void 0);}dispatchRequest(){this.host.dispatchEvent(new s$3(this.context,((t,s)=>{this.unsubscribe&&(this.unsubscribe!==s&&(this.provided=!1,this.unsubscribe()),this.subscribe||this.unsubscribe()),this.value=t,this.host.requestUpdate(),this.provided&&!this.subscribe||(this.provided=!0,this.callback&&this.callback(t,s)),this.unsubscribe=s;}),this.subscribe));}}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class t$2{constructor(t){this.callbacks=new Map,this.updateObservers=()=>{for(const[t,s]of this.callbacks)t(this.t,s);},void 0!==t&&(this.value=t);}get value(){return this.t}set value(t){this.setValue(t);}setValue(t,s=!1){const i=s||!Object.is(t,this.t);this.t=t,i&&this.updateObservers();}addCallback(t,s){s&&(this.callbacks.has(t)||this.callbacks.set(t,(()=>{this.callbacks.delete(t);}))),t(this.value);}clearCallbacks(){this.callbacks.clear();}}

/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class s$1 extends Event{constructor(t){super("context-provider",{bubbles:!0,composed:!0}),this.context=t;}}class e$5 extends t$2{constructor(t,s,e){super(e),this.host=t,this.context=s,this.onContextRequest=t=>{t.context===this.context&&t.composedPath()[0]!==this.host&&(t.stopPropagation(),this.addCallback(t.callback,t.subscribe));},this.attachListeners(),this.host.addController(this);}attachListeners(){this.host.addEventListener("context-request",this.onContextRequest);}hostConnected(){this.host.dispatchEvent(new s$1(this.context));}}

/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class e$4{constructor(){this.pendingContextRequests=new Map,this.onContextProvider=e=>{const s=this.pendingContextRequests.get(e.context);s&&(this.pendingContextRequests.delete(e.context),s.forEach((s=>{const c=s.element,i=s.callback;c&&c.dispatchEvent(new s$3(e.context,i,!0));})));},this.onContextRequest=t=>{if(!t.subscribe)return;const e={element:t.target,callback:t.callback};let s=this.pendingContextRequests.get(t.context);s||(s=new Set,this.pendingContextRequests.set(t.context,s)),s.add(e);};}attach(t){t.addEventListener("context-request",this.onContextRequest),t.addEventListener("context-provider",this.onContextProvider);}detach(t){t.removeEventListener("context-request",this.onContextRequest),t.removeEventListener("context-provider",this.onContextProvider);}}

/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function o$4({context:o}){return o$5({finisher:(t,n)=>{const r=new WeakMap;t.addInitializer((t=>{r.set(t,new e$5(t,o));}));const i=Object.getOwnPropertyDescriptor(t.prototype,n),c=null==i?void 0:i.set,s={...i,set:function(t){var e;null===(e=r.get(this))||void 0===e||e.setValue(t),c&&c.call(this,t);}};Object.defineProperty(t.prototype,n,s);}})}

/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function t$1({context:t,subscribe:o}){return o$5({finisher:(e,n)=>{e.addInitializer((e=>{new s$2(e,t,(r=>{e[n]=r;}),o);}));}})}

/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const e$3=o$4,r$1=t$1;
...
function connectSelector(host, actorRef, selector, compare = exports.defaultCompare) {
...
class SelectState {
    ...
    constructor(context, host, selector, compare = select_controller_js_1.defaultCompare) {
        (this.host = host).addController(this);
        this.serviceContext = new context_1.ContextConsumer(this.host, context, undefined, true);
    ...
    hostConnected() {
        ...
        this.selectorController = new select_controller_js_1.SelectorController(this.host, this.serviceContext.value.service, this.selector, this.compare);
    }
    hostDisconnected() {
...
function connectState(context, host, selector, compare = select_controller_js_1.defaultCompare) {
    return new SelectState(context, host, selector, compare);
}
var connectState_1 = selectState.connectState = connectState;
const compareArrays = (a, b) => a.length === b.length && a.every((value, idx) => value === b[idx]);
var compareArrays_1 = selectState.compareArrays = compareArrays;
const compareObjects = (obj1, obj2) => Object.keys(obj1).length === Object.keys(obj2).length &&
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const s=(i,t)=>{var e,o;const r=i._$AN;if(void 0===r)return !1;for(const i of r)null===(o=(e=i)._$AO)||void 0===o||o.call(e,t,!1),s(i,t);return !0},o$3=i=>{let t,e;do{if(void 0===(t=i._$AM))break;e=t._$AN,e.delete(i),i=t;}while(0===(null==e?void 0:e.size))},r=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(void 0===e)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),l(t);}};function n$2(i){void 0!==this._$AN?(o$3(this),this._$AM=i,r(this)):this._$AM=i;}function h$1(i,t=!1,e=0){const r=this._$AH,n=this._$AN;if(void 0!==n&&0!==n.size)if(t)if(Array.isArray(r))for(let i=e;i<r.length;i++)s(r[i],!1),o$3(r[i]);else null!=r&&(s(r,!1),o$3(r));else s(this,i);}const l=i=>{var t$1,s,o,r;i.type==t.CHILD&&(null!==(t$1=(o=i)._$AP)&&void 0!==t$1||(o._$AP=h$1),null!==(s=(r=i)._$AQ)&&void 0!==s||(r._$AQ=n$2));};class c extends i$1{constructor(){super(...arguments),this._$AN=void 0;}_$AT(i,t,e){super._$AT(i,t,e),r(this),this.isConnected=i._$AU;}_$AO(i,t=!0){var e,r;i!==this.isConnected&&(this.isConnected=i,i?null===(e=this.reconnected)||void 0===e||e.call(this):null===(r=this.disconnected)||void 0===r||r.call(this)),t&&(s(this,i),o$3(this));}setValue(t){if(e$2(this._$Ct))this._$Ct._$AI(t,this);else {const i=[...this._$Ct._$AH];i[this._$Ci]=t,this._$Ct._$AI(i,this,0);}}disconnected(){}reconnected(){}}

/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const e=()=>new o$2;class o$2{}const h=new WeakMap,n$1=e$1(class extends c{render(t){return b}update(t,[s]){var e;const o=s!==this.Y;return o&&void 0!==this.Y&&this.rt(void 0),(o||this.lt!==this.ct)&&(this.Y=s,this.dt=null===(e=t.options)||void 0===e?void 0:e.host,this.rt(this.ct=t.element)),b}rt(i){var t;if("function"==typeof this.Y){const s=null!==(t=this.dt)&&void 0!==t?t:globalThis;let e=h.get(s);void 0===e&&(e=new WeakMap,h.set(s,e)),void 0!==e.get(this.Y)&&this.Y.call(this.dt,void 0),e.set(this.Y,i),void 0!==i&&this.Y.call(this.dt,i);}else this.Y.value=i;}get lt(){var i,t,s;return "function"==typeof this.Y?null===(t=h.get(null!==(i=this.dt)&&void 0!==i?i:globalThis))||void 0===t?void 0:t.get(this.Y):null===(s=this.Y)||void 0===s?void 0:s.value}disconnected(){this.lt===this.ct&&this.rt(void 0);}reconnected(){this.rt(this.ct);}});
...
let LayerSettings = class LayerSettings extends s$4 {
    ...
    showMenu() {
        ...
        if (!this.enable)
            return;
        const { top = 0, left = 0 } = (_b = (_a = this.anchorRef.value) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect()) !== null && _b !== void 0 ? _b : {};
    ...
    compareWith(name, method) {
        var _a;
        (_a = this.stateService.value) === null || _a === void 0 ? void 0 : _a.service.send({
            type: 'COMPARE_IMAGES',
            data: {
                name: this.name,
                fixedImageName: name,
...
__decorate([
    e$6()
], LayerSettings.prototype, "name", void 0);
__decorate([
    e$6()
], LayerSettings.prototype, "otherImages", void 0);
__decorate([
    e$6()
], LayerSettings.prototype, "enable", void 0);
LayerSettings = __decorate([
    e$7('layer-settings')
], LayerSettings);
...
let LayerIcon = class LayerIcon extends s$4 {
    constructor() {
        ...
        this.otherImages = connectState_1(viewerContext, this, (state) => [...state.context.layers.actorContext.keys()].filter(key => {
            var _a, _b;
            return key !== this.name &&
                ((_b = (_a = state.context.images.actorContext.get(this.name)) === null || _a === void 0 ? void 0 : _a.labelImage) === null || _b === void 0 ? void 0 : _b.name) !==
                    key;
        }), compareArrays_1);
        this.selectedName = connectState_1(viewerContext, this, (state) => state.context.images.selectedName);
    }
    getIcon() {
        if (this.layer.type === 'image') {
            if (this.name === this.selectedName.value &&
                this.otherImages.value &&
                this.otherImages.value.length > 0)
                return { icon: optimizedSVGDataUri$5, alt: 'settings' };
            return { icon: optimizedSVGDataUri$n, alt: 'image' };
        }
        if (this.layer.type === 'labelImage')
            return { icon: optimizedSVGDataUri$k, alt: 'labels' };
...
__decorate([
    e$6()
], LayerIcon.prototype, "layer", void 0);
__decorate([
    e$6()
], LayerIcon.prototype, "name", void 0);
__decorate([
    t$3()
], LayerIcon.prototype, "settingsOpen", void 0);
LayerIcon = __decorate([
    e$7('layer-icon')
], LayerIcon);

// Function to create a row with a label and a button
var createButtonRow = function createButtonRow(labelText, buttonCreator, context, mainUIColumn, name) {
  var row = document.createElement('div');
  row.setAttribute('class', style.buttonRow);
...
var createBoundingBoxButton = function createBoundingBoxButton(context, buttonContainer, name) {
  var layerBBoxButton = document.createElement('div');
  layerBBoxButton.innerHTML = "<input id=\"".concat(context.id, "-layerBBoxButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"Bounding Box\" class=\"").concat(style.toggleButton, "\" for=\"").concat(context.id, "-layerBBoxButton\"><img src=\"").concat(optimizedSVGDataUri$s, "\" alt=\"bbox\"/></label>");
...
function createLayerEntry(context, name, layer) {
  ...
  visibleButton.innerHTML = "<input id=\"".concat(context.id, "-visibleButton\" type=\"checkbox\" checked class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Visibility\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-visibleButton\"><img src=\"").concat(optimizedSVGDataUri$3, "\" alt=\"visible\"/></label>");
  var visibleLabel = visibleButton.children[1];
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', visibleLabel);
  // layerEntry.appendChild(visibleButton)
  var invisibleButton = document.createElement('div');
  invisibleButton.innerHTML = "<input id=\"".concat(context.id, "-invisibleButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"Visibility\" class=\"").concat(style.visibleButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-invisibleButton\"><img src=\"").concat(optimizedSVGDataUri$l, " alt=\"invisible\"\"/></label>");
  var invisibleLabel = invisibleButton.children[1];
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', invisibleLabel);
  ...
  var layerLabel = document.createElement('label'); // file_name
  ...
  var icon = makeHtml("<layer-icon class=\"".concat(style.layerIcon, "\"></layer-icon>"));
  icon.layer = layer;
  icon.name = name;
  ...
  if (visible) {
    ...
    switch (actorContext.type) {
      case 'image':
        ...
        break;
      case 'labelImage':
        applyGroupVisibility(context, ['labelImages', 'labelImageWeights'], false);
        break;
      default:
...
var compareUI = function compareUI(context) {
  return function (send, onReceive) {
    ...
    root.setAttribute('style', 'align-self: center; align-content: center; margin-left: 4px; margin-right: 4px');
    var parent = context.layers.compareContainer;
    parent.appendChild(root);
    var checkerboardUi = makeHtml("\n    <div style=\"display: flex; justify-content: space-between;\">\n      <label class=\"".concat(style.inputLabel, "\">Checkerboard Pattern X</label>\n      <input id=\"x-pattern\" type=\"number\" class=\"").concat(style.selector, " ").concat(style.numberInput, "\" style=\"max-width: 3.2ch\" />\n      <label class=\"").concat(style.inputLabel, "\">Y</label>\n      <input type=\"number\" class=\"").concat(style.selector, " ").concat(style.numberInput, "\" style=\"max-width: 3.2ch\" />\n      <label class=\"").concat(style.inputLabel, "\">Z</label>\n      <input type=\"number\" class=\"").concat(style.selector, " ").concat(style.numberInput, "\" style=\"max-width: 3.2ch\" />\n    </div>\n  "));
    ...
    var imageMixRoot = makeHtml("\n    <div style=\"display: flex; justify-content: space-between;\">\n      <label class=\"".concat(style.inputLabel, "\">Image Mix</label>\n      <input id=\"").concat(playImageMixButtonId, "\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\">\n        <label itk-vtk-tooltip itk-vtk-tooltip-top-annotations itk-vtk-tooltip-content=\"animate\" class=\"").concat(style.visibleButton, " ").concat(style.noFlexBasis, " ").concat(style.toggleButton, "\" for=\"").concat(playImageMixButtonId, "\">\n          <img src=\"").concat(optimizedSVGDataUri$g, "\" id=\"").concat(playImageMixImgId, "\" alt=\"animate\" />\n        </label>\n      </input>\n      <input type=\"range\" min=\"0\" max=\"1\" step=\".01\" value=\".5\" \n        class=\"").concat(style.slider, "\" />\n      <input type=\"checkbox\" id=\"").concat(swapButtonId, "\" class=\"").concat(style.toggleInput, "\">\n        <label for=\"").concat(swapButtonId, "\" itk-vtk-tooltip itk-vtk-tooltip-left-fullscreen itk-vtk-tooltip-content=\"Swap image\" class=\"").concat(style.rotateButton, " ").concat(style.toggleButton, "\">\n          <img src=\"").concat(optimizedSVGDataUri$b, "\" alt=\"rotate\"/>\n        </label>\n      </input>\n    </div>\n  "));
    ...
    var animateImageImg = imageMixRoot.querySelector("#".concat(playImageMixImgId));
    var update = function update() {
      ...
      var _ref = imageContext !== null && imageContext !== void 0 ? imageContext : {},
      ...
      if (method && method !== 'disabled') root.style.display = 'block';else root.style.display = 'none';
      if (checkerboard) {
        checkerboardUi.style.display = 'flex';
      } else {
        checkerboardUi.style.display = 'none';
      }
      var _ref3 = (_compare$pattern = compare === null || compare === void 0 ? void 0 : compare.pattern) !== null && _compare$pattern !== void 0 ? _compare$pattern : [],
      ...
      yPattern.value = y;
      zPattern.value = z;
      swapOrder.checked = (_compare$swapImageOrd = !!(compare !== null && compare !== void 0 && compare.swapImageOrder)) !== null && _compare$swapImageOrd !== void 0 ? _compare$swapImageOrd : false;
      imageMixSlider.value = (_compare$imageMix = compare === null || compare === void 0 ? void 0 : compare.imageMix) !== null && _compare$imageMix !== void 0 ? _compare$imageMix : 0.5;
      animateImageImg.src = imageContext !== null && imageContext !== void 0 && imageContext.imageMixAnimation ? optimizedSVGDataUri$h : optimizedSVGDataUri$g;
    };
    update();
    ...
    xPattern.addEventListener('change', function (event) {
      ...
      event.preventDefault();
      event.stopPropagation();
      var _ref5 = (_context$images$actor = context.images.actorContext.get(context.images.selectedName).compare.pattern) !== null && _context$images$actor !== void 0 ? _context$images$actor : [],
    ...
    yPattern.addEventListener('change', function (event) {
      ...
      event.preventDefault();
      event.stopPropagation();
      var _ref7 = (_context$images$actor2 = context.images.actorContext.get(context.images.selectedName).compare.pattern) !== null && _context$images$actor2 !== void 0 ? _context$images$actor2 : [],
    ...
    zPattern.addEventListener('change', function (event) {
      ...
      event.preventDefault();
      event.stopPropagation();
      var _ref9 = (_context$images$actor3 = context.images.actorContext.get(context.images.selectedName).compare.pattern) !== null && _context$images$actor3 !== void 0 ? _context$images$actor3 : [],
...
function createInterpolationButton(context, uiRow) {
  ...
  interpolationButton.innerHTML = "<input id=\"".concat(context.id, "-toggleInterpolationButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-top-screenshot itk-vtk-tooltip-content=\"Interpolation\" class=\"").concat(style.interpolationButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-toggleInterpolationButton\"><img src=\"").concat(optimizedSVGDataUri$m, "\" alt=\"interpolation\" /></label>");
...
function createColorMapIconSelector(colorMapSelectorDiv) {
  ...
  var iconSelect = new IconSelect("".concat(colorMapSelectorDiv.id), colorMapSelectorDiv, iconSelectParameters);
  colorMapSelectorDiv.style.width = '154px';
  // put above lower down label map color selector
  colorMapSelectorDiv.style.zIndex = '2001';
  var filteredIcons = new Map(Array.from(ColorMapIcons.entries()).concat(Array.from(CategoricalColorIcons.entries()).filter(function (_ref) {
...
function createWindowLevelReset(context, uiContainer) {
  ...
  windowLevelResetButton.innerHTML = "\n    <div itk-vtk-tooltip itk-vtk-tooltip-left itk-vtk-tooltip-content=\"Reset range to ROI\" class=\"".concat(style.windowLevelButton, "\">\n      <img src=\"").concat(optimizedSVGDataUri$c, "\" alt=\"gradient opacity\"/>\n    </div>\n  ");
  ...
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', windowLevelResetButtonLabel);
...
function createColorRangeInput(context, imageUIGroup) {
  ...
  minimumInput.addEventListener('change', function (event) {
    ...
    var name = context.images.selectedName;
    var actorContext = context.images.actorContext.get(name);
    var currentRange = actorContext.colorRanges.get(actorContext.selectedComponent);
    var newRange = [];
...
class q {
  ...
  setPoints(t) {
    return [...this._points].forEach((e) => this.deletePoint(e)), this.addPoints(t);
  }
  removePoint(t) {
...
class Nt {
  ...
  setPoints(t) {
    this.points.setPoints(t), this.pointController.updatePoints(), this.line.update(), this.background.render();
  }
  getColorRange() {
...
var updateContextPiecewiseFunction = function updateContextPiecewiseFunction(context, points) {
...
var updateContextColorRange = function updateContextColorRange(context, points) {
  if (!context.images.piecewiseFunctions) return; // not ready yet
...
var vtkPiecewiseGaussianWidgetFacade = function vtkPiecewiseGaussianWidgetFacade(tfEditor, context) {
  ...
  return {
    ...
    setPoints: function setPoints(points) {
      ...
      var arePointsModified = points.length !== currentPoints.length || points.some(function (_ref, idx) {
    ...
    setColorRange: function setColorRange(newRange) {
      ...
      if (displayedRange.some(function (v, i) {
        return v !== newRange[i];
      })) {
...
var createTransferFunctionEditor = function createTransferFunctionEditor(context, mount) {
  var editor = new Nt(mount);
  return vtkPiecewiseGaussianWidgetFacade(editor, context);
};

var createTransferFunctionWidget = function createTransferFunctionWidget(context, imagesUIGroup) {
  ...
  // This row needs background different from normal uiRows, to aid
  // in the illusion that it's the content portion of a tabbed pane
  transferFunctionWidgetRow.setAttribute('style', 'background: rgba(127, 127, 127, 0.5);');
  imagesUIGroup.appendChild(transferFunctionWidgetRow);
  transferFunctionWidgetRow.appendChild(piecewiseWidgetContainer);
  var transferFunctionWidget = createTransferFunctionEditor(context, piecewiseWidgetContainer);
  context.images.transferFunctionWidget = transferFunctionWidget;
};
var applyPiecewiseFunctionPointsToEditor = function applyPiecewiseFunctionPointsToEditor(context, event) {
...
function createShadowToggle(context, uiContainer) {
  ...
  shadowButton.innerHTML = "<input id=\"".concat(context.id, "-toggleShadowButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\" checked><label itk-vtk-tooltip itk-vtk-tooltip-top-screenshot itk-vtk-tooltip-content=\"Use shadow\" class=\"").concat(style.shadowButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-toggleShadowButton\"><img src=\"").concat(optimizedSVGDataUri$6, "\" alt=\"shadow\" /></label>");
  var shadowButtonInput = shadowButton.children[0];
  var shadowButtonLabel = shadowButton.children[1];
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', shadowButtonLabel);
...
function createGradientOpacitySlider(context, uiContainer) {
  ...
  sliderEntry.innerHTML = "\n    <!-- Remove slider\n        <div itk-vtk-tooltip itk-vtk-tooltip-top-fullscreen itk-vtk-tooltip-content=\"Gradient opacity scale\" class=\"".concat(style.gradientOpacitySlider, "\">\n          <img src=\"").concat(optimizedSVGDataUri$p, "\" alt=\"gradient opacity\"/>\n        </div>\n        <div class=\"").concat(style.gradientOpacityScale, "\" style=\"display: none;\">\n          <input type=\"range\" min=\"0\" max=\"0.99\" value=\"0.5\" step=\"0.01\" id=\"").concat(context.id, "-gradientOpacityScaleSlider\" />\n        </div>\n    -->\n    <label for=\"").concat(context.id, "-gradientOpacitySlider\" class=\"").concat(style.descriptionLabel, "\">\n      Opacity\n    </label>\n    <input type=\"range\" min=\"0\" max=\"1\" value=\"0.2\" step=\"0.01\" orient=\"vertical\"\n      id=\"").concat(context.id, "-gradientOpacitySlider\"\n      class=\"").concat(style.slider, "\" />");
  ...
  var gradientOpacitySlider = sliderEntry.querySelector("#".concat(context.id, "-gradientOpacitySlider"));
  context.images.gradientOpacitySlider = gradientOpacitySlider;
...
function createSampleDistanceSlider(context, uiContainer) {
  var sliderEntry = document.createElement('div');
  sliderEntry.setAttribute('class', style.sliderEntry);
  sliderEntry.innerHTML = "\n    <div itk-vtk-tooltip itk-vtk-tooltip-top-screenshot itk-vtk-tooltip-content=\"Volume sample distance\" class=\"".concat(style.sampleDistanceButton, "\">\n      <img src=\"").concat(optimizedSVGDataUri$a, "\" alt=\"sample distance\" />\n    </div>\n    <input type=\"range\" min=\"0\" max=\"1\" value=\"0.25\" step=\"0.01\"\n      class=\"").concat(style.slider, " ").concat(context.id, "-spacing\" />");
  var spacingElement = sliderEntry.querySelector(".".concat(context.id, "-spacing"));
...
function applyCinematicChanged(context, _ref2) {
  ...
  sliderMap.get('scatteringBlend').disabled = !cinematicParameters.isCinematicPossible;
...
function createWindowLevelToggle(context, uiContainer) {
  ...
  windowLevelToggle.innerHTML = "<input id=\"".concat(context.id, "-windowLevelToggle\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\"><label itk-vtk-tooltip itk-vtk-tooltip-left itk-vtk-tooltip-content=\"Toggle window/level interactor\" class=\"").concat(style.windowLevelButton, " ").concat(style.toggleButton, "\" for=\"").concat(context.id, "-windowLevelToggle\"><img src=\"").concat(optimizedSVGDataUri$1, "\" alt=\"Window/Level\" /></label>");
  var windowLevelToggleInput = windowLevelToggle.children[0];
  var windowLevelToggleLabel = windowLevelToggle.children[1];
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', windowLevelToggleLabel);
...
function createVolumeRenderingInputs(context, imagesUIGroup) {
  ...
  createShadowToggle(context);
  createGradientOpacitySlider(context, volumeRow1);
  createWindowLevelToggle(context);
...
function createCategoricalColorIconSelector(categoricalColorSelectorDiv) {
  ...
  var iconSelect = new IconSelect("".concat(categoricalColorSelectorDiv.id), categoricalColorSelectorDiv, iconSelectParameters);
...
function createLabelImageColorWidget(context) {
  ...
  var iconSelector = createCategoricalColorIconSelector(categoricalColorSelector);
  ...
  var sliderEntry = document.createElement('div');
  sliderEntry.setAttribute('class', style.sliderEntry);
  sliderEntry.innerHTML = "\n  <div itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"Label image blend\" class=\"".concat(style.gradientOpacitySlider, "\">\n    <img src=\"").concat(optimizedSVGDataUri$i, "\" alt=\"opacity\"/>\n  </div>\n  <input type=\"range\" min=\"0\" max=\"1\" value=\"0.5\" step=\"0.01\"\n  id=\"").concat(context.id, "-labelImageBlendSlider\"\n  class=\"").concat(style.slider, "\" />");
  var labelImageBlendSlider = sliderEntry.querySelector("#".concat(context.id, "-labelImageBlendSlider"));
  ...
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', sliderEntryDiv);
...
function createLabelMapWeightWidget(context) {
  ...
  uniqueLabelSelectorDiv.id = "".concat(context.id, "-labelImageUniqueLabelSelector");
  ...
  sliderEntry.innerHTML = "\n    <input type=\"range\" min=\"0\" max=\"1\" value=\"1.0\" step=\"0.05\" id=\"".concat(context.id, "-labelImageWeightSlider\" class=\"").concat(style.slider, "\" />");
  var weightElement = sliderEntry.querySelector("#".concat(context.id, "-labelImageWeightSlider"));
  ...
  weightElement.addEventListener('input', function (event) {
    ...
    if (actorContext.selectedLabel === 'all') {
      ...
      labelImageWeights.set(parseInt(actorContext.selectedLabel), Number(weightElement.value));
    }
    context.service.send({
...
function createImagesInterface(context) {
  ...
  applyGroupVisibility(context, ['images', 'labelImages', 'labelImageWeights'], false);
}
...
function updateAvailableComponents(context) {
  ...
  if (image) {
    ...
    context.images.componentSelector.innerHTML = new Array(components).fill(undefined).map(function (_, ii) {
      return ii;
    }).map(function (idx, component) {
      return "<input name=\"tabs\" type=\"radio\" id=\"tab-".concat(component, "\" ").concat(idx === 0 ? 'checked="checked"' : '', " class=\"").concat(style.componentTab, "\" data-component-index=\"").concat(component, "\"/><label for=\"tab-").concat(component, "\" class=\"").concat(style.compTabLabel, "\">&nbsp;").concat(component, "&nbsp;<input type=\"checkbox\" ").concat(actorContext.componentVisibilities[idx] ? 'checked="checked"' : '', " class=\"").concat(style.componentVisibility, "\" data-component-index=\"").concat(component, "\"></label>");
    }).join('');
...
function applyColorRange(context, event) {
  ...
  var actorContext = context.images.actorContext.get(name);
  if (name !== context.images.selectedName || component !== actorContext.selectedComponent) {
    return;
  }
  ...
  var colorRangeNormalized = [(colorRange[0] - fullRange[0]) / diff, (colorRange[1] - fullRange[0]) / diff];
...
function applyColorRangeBounds(context, event) {
  ...
  var maximumInput = context.images.colorRangeInputRow.children[3].children[0];
  var image = actorContext.image;
  if (image && image.imageType.componentType === 'float' || image.imageType.componentType === 'double') {
...
function applyColorMap(context, _ref) {
  ...
  if (component === actorContext.selectedComponent) {
    ...
    if (colorTransferFunction) {
      context.images.transferFunctionWidget.setColorTransferFunction(colorTransferFunction);
    }
    ...
    actorContext.fusedImage.getPointData().getScalars()) {
      var range = actorContext.fusedImage.getPointData().getScalars().getRange(component);
...
function updateRenderedImageInterface(context, event) {
  ...
  var points = actorContext.piecewiseFunctionPoints.get(actorContext.selectedComponent);
...
function applyHistogram(context, event) {
  ...
  var histogram = (_event$data$histogram = event.data.histogram) !== null && _event$data$histogram !== void 0 ? _event$data$histogram : [];
...
function selectImageComponent(context, event) {
  ...
  var piecewiseFunctionPoints = actorContext.piecewiseFunctionPoints.get(component);
  ...
  if (actorContext.colorMaps.has(component)) {
    ...
    context.images.iconSelector.setSelectedValue(actorContext.colorMaps.get(component));
  }
...
function applyComponentVisibility(context, event) {
  ...
  actorContext.componentVisibilities.forEach(function (visibility, compIdx) {
    var element = componentSelector.querySelector("input[data-component-index=\"".concat(compIdx, "\"][type=\"checkbox\"]"));
...
function applyLabelNames(context, event) {
  ...
  labelNames.forEach(function (name, label) {
    return optionsList.push("<option ".concat(label === actorContext.selectedLabel ? 'selected' : '', " value=\"").concat(label, "\">").concat(name, "</option>"));
  });
...
function applySelectedLabel(context, event) {
  ...
  if (selectedLabel === 'all') {
    ...
    context.images.labelImageWeightSlider.value = actorContext.labelImageWeights.get(selectedLabel);
...
function applyScaleCount(input, scaleCount) {
  ...
  _toConsumableArray(Array(scaleCount).keys()).reverse().forEach(function (i) {
...
var scaleSelector = function scaleSelector(context, event) {
  return function (send, onReceive) {
    ...
    scaleSelectorDiv.setAttribute('style', 'display: flex; align-items: center; justify-content: center; height: 25px; margin-right: 5px');
    context.images.componentAndScale.appendChild(scaleSelectorDiv);
    scaleSelectorDiv.innerHTML = "\n    <span class=\"".concat(style.descriptionLabel, "\">Resolution Scale</span>\n    <div itk-vtk-tooltip itk-vtk-tooltip-top-screenshot itk-vtk-tooltip-content=\"Resolution Scale\"\n      class=\"").concat(style.blendModeButton, "\">\n      <img src=\"").concat(optimizedSVGDataUri$9, "\" alt=\"Resolution Scale\" />\n    </div>\n    ");
    ...
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', scaleSelectorIcon);
    ...
    scaleSelector.addEventListener('change', function (event) {
      event.preventDefault();
      event.stopPropagation();
      var imageActor = context.images.imageRenderingActors.get(context.images.selectedName);
    ...
    function onImageAssigned(name) {
      ...
      var image = (_imageActorContext$im = imageActorContext.image) !== null && _imageActorContext$im !== void 0 ? _imageActorContext$im : imageActorContext.labelImage;
    ...
    onReceive(function (event) {
      ...
      if (type === 'IMAGE_ASSIGNED') {
        ...
        scaleSelector.value = context.images.actorContext.get(event.data.name).loadedScale;
      }
    });
  };
};
...
function toggleWindowLevel(context, event) {
  ...
  var fullRange = actorContext.colorRangeBounds.get(actorContext.selectedComponent);
  ...
  if (wl) {
    ...
    var step = Math.pow(10, Math.ceil(Math.log((fullRange[1] - fullRange[0]) / 1000)));
    minimumInput.step = step;
    maximumInput.step = step;
  } else {
...
var imagesUIMachineOptions = {
  actions: {
    ...
    // Call a function that basically doesn't do anythign as the element has been commented out from the user interface
...
function createDistanceWidget(context, widgetsUIGroup) {
  ...
  distanceButton.innerHTML = "<input id=\"".concat(viewerDOMId, "-toggleDistanceButton\" type=\"checkbox\" class=\"").concat(style.toggleInput, "\" checked><label itk-vtk-tooltip itk-vtk-tooltip-top itk-vtk-tooltip-content=\"Length\" class=\"").concat(style.distanceButton, " ").concat(style.toggleButton, "\" for=\"").concat(viewerDOMId, "-toggleDistanceButton\"><img src=\"").concat(optimizedSVGDataUri$j, "\" alt=\"distance\"/></label>");
  ...
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', distanceButtonLabel);
...
function applyDistanceWidgetValue(context, event) {
  context.widgets.distanceValueElement.setAttribute('value', "".concat(event.data));
}
...
function applyMainContrastSensitiveStyle$1(context) {
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.collapseUIButton);
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.screenshotButton);
  if (context.main.fullscreenButton) {
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.fullscreenButton);
  }
  if (context.main.rotateButtonLabel) {
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.rotateButtonLabel);
  }
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.annotationsButtonLabel);
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.axesButtonLabel);
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.cropButtonLabel);
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.resetCropButtonLabel);
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.bgColorButtonLabel);
  if (!context.use2D) {
    applyContrastSensitiveStyleToElement(context, 'tooltipButton', context.main.xPlaneButtonLabel);
    applyContrastSensitiveStyleToElement(context, 'tooltipButton', context.main.yPlaneButtonLabel);
    applyContrastSensitiveStyleToElement(context, 'tooltipButton', context.main.zPlaneButtonLabel);
    applyContrastSensitiveStyleToElement(context, 'tooltipButton', context.main.volumeButtonLabel);
    applyContrastSensitiveStyleToElement(context, 'tooltipButton', context.main.viewPlanesButtonLabel);
  }
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.main.resetCameraButtonLabel);
}
...
function applyImagesContrastSensitiveStyle(context) {
  if (context.images.distanceButtonLabel) {
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.images.distanceButtonLabel);
    applyContrastSensitiveStyleToElement(context, 'distanceLabel', context.images.distanceLabel);
  }
  if (context.images.shadowButtonLabel) {
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.images.shadowButtonLabel);
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.images.sliderEntryDiv);
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.images.volumeSampleDistanceDiv);
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.images.blendModeDiv);
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.images.labelImageBlendDiv);
    applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.images.scaleSelectorIconDiv);
  }
}

function applyMainContrastSensitiveStyle(context) {
  applyContrastSensitiveStyleToElement(context, 'invertibleButton', context.widgets.distanceButtonLabel);
  applyContrastSensitiveStyleToElement(context, 'distanceLabel', context.widgets.distanceLabel);
}
...
class IconButton extends s$9 {
    ...
    renderFocusRing() {
        return x$1 `<md-focus-ring part="focus-ring" for=${this.href ? 'link' : 'button'}></md-focus-ring>`;
    }
    renderRipple() {
...
let CollapseUi = class CollapseUi extends s$4 {
    constructor() {
        super(...arguments);
        this.service = connectState_1(viewerContext, this, (state) => state.context.service);
    }
    render() {
        return y `
...
function updateDrawer(context) {
  ...
  if (drawerChild) drawerChild.style.width = context.drawer.opened ? 'var(--_container-width)' : '';
}
function toggleUICollapsed(context, event, actionMeta) {
  ...
  if (actionMeta) {
    context.uiCollapsed = actionMeta.state.value.active.uiCollapsed === 'enabled';
  }
...
function createInterface(context) {
  ...
  var sidebar = makeHtml("\n    <div class='".concat(style.uiContainer, "'>\n      <md-navigation-drawer type=\"dismissible\" id='drawer' class='").concat(style.drawer, "'></md-navigation-drawer>\n      <collapse-ui class='").concat(style.collapseButton, "'/>\n    </div>\n  "));
